...
function load() {
  const loadgame = JSON.parse(localStorage.getItem("ordinalMarkupTimes1000Save"));
...
function save() {
  if (AF === 0) {
    localStorage.setItem("ordinalMarkupTimes1000Save", JSON.stringify(game))
  };
}
// hi
